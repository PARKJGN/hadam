                                    ...
                                    <div class="col-list-wrap fw-col-list-wrap">
                                        ...
                                        <div class="list-main-wrap fl-wrap card-listing">
	                                                ...
	                                                <div class="listing-item">
	                                                    <article class="geodir-category-listing fl-wrap">
	                                                        <div class="catedir-category-img">	                                                        	
	                                                            <a href="locationDetail?locationId=${categoryLoc.locationId }">
	                                                        ...
	                                                        <div class="catedir-category-content fl-wrap">
	                                                            <div class="catedir-category-content-title fl-wrap">
	                                                                <h3 class="title-sin_map"><a href="locationDetail?locationId=${categoryLoc.locationId }">${categoryLoc.locationName }</a></h3> 
	                                                            </div>
                                            ...
                                            <div class="pagination" id="page" >
		                                        <a href="categoryLocList?middleCategory=${middleCategory }&page=1" class="prevposts-link"><i class="fa fa-caret-left"></i></a>
		                                        <a href="categoryLocList?middleCategory=${middleCategory }&page=${prevMax}" class="prevposts-link"><i class="fa fa-caret-left"></i></a>
		                                        
		                                        <c:forEach items="${numList}" var="num">
		                                        	<a href="categoryLocList?middleCategory=${middleCategory }&page=${num}">${num}</a>		                                       
		                                        </c:forEach>
		                                        
		                                        <a href="categoryLocList?middleCategory=${middleCategory }&page=${nextMin}" class="nextposts-link"><i class="fa fa-caret-right"></i></a>
		                                        <a href="categoryLocList?middleCategory=${middleCategory }&page=${lastPage}" class="nextposts-link"><i class="fa fa-caret-right"></i></a>
		                                    </div>					
