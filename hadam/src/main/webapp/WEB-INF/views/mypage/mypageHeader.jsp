			...
			<div class="dasboard-menu">
				...
				<ul class="dasboard-menu-wrap">
					...
					<li><a href="/mypage/mypageFavorites"><i
							class="fa-regular fa-heart"></i></i>찜꽁빵꽁</a></li>
					<li><a href="/mypage/mypageEntry"><i
							class="far fa-envelope"></i> 동행신청 <span></span></a></li>
					<li><a href="/mypage/mypageSchedule"> <i
							class="far fa-calendar-check"></i> 내 스케줄 <span>2</span></a></li>
