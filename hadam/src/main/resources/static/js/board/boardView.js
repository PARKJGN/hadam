               ...
               const commentWrite = (memberIndex) => {
      			...
      			$.ajax ({
      				...
      				success : function(commentList){
      					console.log("작성 성공");
      					console.log(commentList[0].commentId);
      					...
      					// 댓글작성자의 memberIndex와 로그인한 사용자의 memberIndex가 다르면 신고 버튼 보임
      					 if ( commentList[i].memberIndex !== memberIndex) {						
      						output += '<button type="submit" id="danger"class="btn btn-danger" onclick="commentReport(\'' + commentList[0].commentId + '\')">신고</button>';
      					}    
